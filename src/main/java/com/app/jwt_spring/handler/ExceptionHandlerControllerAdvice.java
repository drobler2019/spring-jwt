...
public class ExceptionHandlerControllerAdvice {
    ...
    public ResponseEntity<Problem> duplicateUsernameException(HttpServletRequest request,DataIntegrityViolationException dataIntegrityViolationException) {
        var response = HateoasUtl.buildProblem(request.getRequestURI(),HttpStatus.BAD_REQUEST,dataIntegrityViolationException);
